DROP DATABASE if exists db_vinos;
...
-- Vista 3: Vinos blend (los que tienen varias cepas en el mismo vino). 
...
-- TRIGGER 1) CREAMOS UN TRIGGER CON SU TABLA DE AUDITORIA PARA CUANDO HAYA MODIFICACION DE PRECIOS EN LA TABLA "VINO";
-- Creacion tabla de auditoria:
...
DROP TRIGGER IF EXISTS tr_cambio_precio;
...
-- TRIGGER 2) Evitar precios invalidos.

DROP TRIGGER IF EXISTS tr_precio_invalido;
DELIMITER //
